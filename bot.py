...
MISSION_HOOKS = {
    ...
    9: (
        ...
        "В видео я объясню, почему помощь другим — твоя миссия, но в этой же "
    ...
    12: (
        ...
        "В видео я объясню, почему жертвенность — твоя миссия и одновременно "
    ...
    13: (
        ...
        "В видео я объясню, почему твоя миссия — быть первооткрывателем "
    ...
    14: (
        ...
        "В видео я объясню, почему твоя миссия — учить мир равновесию, "
    ...
    16: (
        ...
        "от этих обвалов.\n\n"
        "В видео я объясню, почему разрушение старого — часть твоей миссии, "
    ...
    17: (
        ...
        "В видео я объясню, почему твоя миссия — вдохновлять и светить, "
    ...
    19: (
        ...
        "В видео я объясню, почему твоя миссия — стать той, на кого "
...
async def send_offer(update, arcane):
    ...
    if hook:
        text = (
            ...
            f"{hook}\n\n"
            f"Это 12 минут + PDF с практикой активации.\n\n"
